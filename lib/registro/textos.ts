...
export const REGISTRO = {
   ...
   * `public/`). Es la guía de Evacol, la marca de las sandalias del kit. Sin imagen, el
   * formulario muestra la tabla de `GUIA_SANDALIAS`.
   */
  guiaSandaliasImagen: "/registro/guia-tallas.jpg" as string | null,
...
/**
 * Talla → largo del pie en centímetros (talón a la punta del dedo más largo), según la guía
 * de Evacol (`public/registro/guia-tallas.jpg`). Respaldo por si se quita la imagen.
 */
export const GUIA_SANDALIAS: ReadonlyArray<{ eu: number; cm: string }> = [
  { eu: 35, cm: "22,5" }, { eu: 36, cm: "23" }, { eu: 37, cm: "24" }, { eu: 38, cm: "24,5" },
  { eu: 39, cm: "25" }, { eu: 40, cm: "26" }, { eu: 41, cm: "26,5" }, { eu: 42, cm: "27" },
  { eu: 43, cm: "28" }, { eu: 44, cm: "29" }, { eu: 45, cm: "30" },
];
