  ...
  const buffer = await renderToBuffer(
    LiquidacionFinalPDF({
      data: {
        ...
        penalty_date: s.penalty_date ?? null,
        penalty_trm_eur_cop: s.penalty_trm_eur_cop != null ? Number(s.penalty_trm_eur_cop) : null,
        penalty_cop: s.penalty_cop != null ? Number(s.penalty_cop) : null,
